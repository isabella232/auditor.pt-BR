...
<table id="table_98A2E3F7B3154EEFA76D0CAE2FE97CAB"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Implemente a tag da Advertising Cloud usando a extensão Advertising Cloud para o Adobe Experience Platform Launch. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Um objeto _satellite global não foi encontrado no DOM. O Platform Launch não está instalado ou não está sendo executado. </p> </td> 
